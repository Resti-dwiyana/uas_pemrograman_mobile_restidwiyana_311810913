...
@Override
    ...
    private void initView(){
        ...
        textHarga = (EditText) findViewById(R.id.add_new_email);
        textHarga = (EditText) findViewById(R.id.add_new_address);
        textHarga = (EditText) findViewById(R.id.add_new_gender);
        textHarga = (EditText) findViewById(R.id.add_new_phone);
    }
